...
public class TeamFreeBoardControllerTEST extends CommonTestConfig {
	...
	public void test_10() throws Exception {
		...
		this.mvc
			.perform(RestDocumentationRequestBuilders.post("/api/teamManage/freeBoard/{code}", "ECCBC87E")
	...
	public void test_11() throws Exception {
		super.login("dlwodyd202", "a");
		FreeBoardDTO freeBoard = FreeBoardDTO.builder().title("Update board").content("Update !!.").build();
		String json = objMapper.writeValueAsString(freeBoard);
		this.mvc
			.perform(RestDocumentationRequestBuilders.put("/api/teamManage/freeBoard/{seq}", "56")
				.header(super.AUTHRIZATION, auth).contentType(MediaType.APPLICATION_JSON).content(json))
			.andDo(print()).andExpect(status().isOk());
	}
	...
	public void test_12() throws Exception {
		...
		this.mvc
			.perform(
				RestDocumentationRequestBuilders.delete("/api/teamManage/freeBoard/{seq}", "56").header(super.AUTHRIZATION, auth))
			.andDo(print()).andExpect(status().isOk());
	}
	...
	public void test_13() throws Exception {
		super.login("dlwodyd202", "a");
		this.mvc.perform(get("/api/teamManage/freeBoard/{code}/all", "ECCBC87E").header(AUTHRIZATION, auth)).andDo(print())
	...
	public void test_14() throws Exception {
		super.login("dlwodyd202", "a");
		this.mvc.perform(get("/api/teamManage/freeBoard/{seq}", "59").header(AUTHRIZATION, auth)).andDo(print())
			.andExpect(status().isOk());
	}
