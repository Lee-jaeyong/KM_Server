...
import ljy.book.admin.professor.restAPI.KM_Class_Professor_RestController;
...
public class Km_classResource extends EntityModel<KM_classVO> {
	...
	public Km_classResource(KM_classVO content) {
		super(content);
		add(ControllerLinkBuilder.linkTo(KM_Class_Professor_RestController.class).slash("").withSelfRel());
	}
